...
**Implementation Details:**
The complete SWAN for near-field ptychography is available in the [MATLAB directory](https://github.com/THUHoloLab/Swift-hashConvolutional-INR/tree/main/Nearfield-ptycho), including example usage and comparison between ePIE and instantNGP-based implementation, and SWAN. <br>
